...
- [ayo-run/wcb](https://github.com/ayo-run/wcb) - Web Components in Easy Mode
- [hound-search/hound](https://github.com/hound-search/hound) - Lightning fast code searching made easy
- [ayo-run/McFly](https://github.com/ayo-run/McFly) - Back to the Basics. Into the Future.
...
- [CompassMB/MBCompass](https://github.com/CompassMB/MBCompass) - Modern FOSS Compass and Navigation app without Ads, IAP or Tracking
...
- [frontenddogma/rote-learning-html-css](https://github.com/frontenddogma/rote-learning-html-css) - The book “Rote Learning HTML & CSS”
...
- [spatie/scotty](https://github.com/spatie/scotty) - A beautiful SSH task runner
...
- [Sylius/PayumStripePlugin](https://github.com/Sylius/PayumStripePlugin) - Sylius Payum Stripe gateway plugin (with SCA support)
...
- [VladSez/easy-invoice-pdf](https://github.com/VladSez/easy-invoice-pdf) - Free & Open-Source Invoice Generator – Live PDF Preview, No Sign-Up, 100% In-Browser. Includes a Stripe-style invoice template. Star if you like it 🌟
...
- [NuclearPlayer/nuclear-xrd](https://github.com/NuclearPlayer/nuclear-xrd) - Moved to nukeop/nuclear
